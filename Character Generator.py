...
# Import random number generator and math
import random
import math
...
simpleWeapons = ["Club", "Dagger", "Greatclub", "Handaxe", "Javelin", "Light Hammer", "Mace", "Quarterstaff",
...
for i in equipment:
    ...
    if i == "Light Crossbow":
        attacks.extend(["Light Crossbow:", "1d8 Piercing", "80/320 feet", "Ammunition (range 80/320), Loading, ","Two-Handed"])
    if i == "Dart":
